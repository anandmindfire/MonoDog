  ...
  return (
    <div className="space-y-4 p-6 max-w-md">
      ...
      <div className="space-y-3">
        <div>
          <label className="text-subheading text-sm block mb-1">Normal Input</label>
          <input 
            type="text" 
        ...
        <div>
          <label className="text-subheading text-sm block mb-1">Success Input</label>
          <input 
            type="text" 
        ...
        <div>
          <label className="text-subheading text-sm block mb-1">Error Input</label>
          <input 
            type="text" 
        ...
        <div>
          <label className="text-subheading text-sm block mb-1">Disabled Input</label>
          <input 
            type="text" 
...
export function ColorPaletteExamples() {
  const colorGroups = [
    ...
    { name: 'Success', colors: ['50', '100', '200', '300', '400', '500', '600', '700', '800', '900'] },
    { name: 'Warning', colors: ['50', '100', '200', '300', '400', '500', '600', '700', '800', '900'] },
    { name: 'Error', colors: ['50', '100', '200', '300', '400', '500', '600', '700', '800', '900'] },
  ];
