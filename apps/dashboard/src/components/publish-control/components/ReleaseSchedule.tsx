...
export default function ReleaseSchedule({ releases, selectedStatus, onStatusChange }: ReleaseScheduleProps) {
      ...
      <div className="p-6">
        <div className="space-y-4">
          {mockReleases.map((release) => (
            <div key={release.id} className="border rounded-lg p-4 hover:bg-gray-50">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">by {release.author}</div>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
