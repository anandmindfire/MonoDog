...
import { getStatusColor, formatDuration, formatRelativeTime, getPipelineHealth } from '../utils/ci.utils';
    ...
    return (
      <div className="bg-white rounded-lg shadow border p-6">
        <div className="text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No Pipelines Configured</h3>
          <p className="text-gray-600 mb-4">
            Get started by creating your first CI/CD pipeline to automate builds and deployments.
          </p>
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      onPipelineToggle(pipeline.id, pipeline.status !== 'active');
                    }}
              ...
              <div className="mt-3 grid grid-cols-4 gap-4 text-xs">
                <div>
                  ...
                  <div className={`font-medium ${
                    pipeline.successRate >= 90 ? 'text-green-600' :
                    pipeline.successRate >= 70 ? 'text-yellow-600' : 'text-red-600'
                  }`}>
              ...
              <div className="mt-3">
                <div className="flex items-center justify-between text-xs mb-1">
                  ...
                  <span className="font-medium text-gray-900">{pipeline.successRate}%</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div 
                    className={`h-2 rounded-full transition-all duration-300 ${
                      pipeline.successRate >= 90 ? 'bg-green-500' :
                      pipeline.successRate >= 70 ? 'bg-yellow-500' : 'bg-red-500'
                    }`}
