...
export default function BuildOverview({ stats, onRefresh, loading = false }: BuildOverviewProps) {
  return (
        ...
        <div className="card p-4">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-heading text-2xl text-success-600">{stats.successful}</p>
            </div>
          </div>
        </div>
        ...
        <div className="card p-4">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-heading text-2xl text-error-600">{stats.failed}</p>
            </div>
          </div>
        </div>
        ...
        <div className="card p-4">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-heading text-2xl text-info-600">{stats.running}</p>
            </div>
          </div>
        </div>
        ...
        <div className="card p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className={`text-lg font-bold ${
              stats.successRate >= 90 ? 'text-success-600' :
              stats.successRate >= 70 ? 'text-warning-600' : 'text-error-600'
            }`}>
              {stats.successRate}%
            </span>
          </div>
          <div className="w-full bg-neutral-200 rounded-full h-2">
            <div 
              className={`h-2 rounded-full transition-all duration-300 ${
                stats.successRate >= 90 ? 'bg-success-500' :
                stats.successRate >= 70 ? 'bg-warning-500' : 'bg-error-500'
              }`}
