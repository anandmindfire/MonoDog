  ...
  return (
    <div className="space-y-6">
      ...
      {filteredBuilds.length === 0 && builds.length > 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-4">
            No builds match your current filters. Try adjusting your search criteria.
          </p>
          <button
            onClick={() => setFilters({ package: 'all', status: 'all', pipeline: 'all', dateRange: 'all' })}
      ...
      {builds.length === 0 && !loading && (
        <div className="text-center py-12">
          <div className="text-gray-400 text-6xl mb-4">🚀</div>
          <h3 className="text-lg font-medium text-gray-900 mb-2">No CI/CD data available</h3>
          <p className="text-gray-600 mb-4">
