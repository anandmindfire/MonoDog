...
export default function HealthAlerts({ alerts, onAlertDismiss }: HealthAlertsProps) {
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
          ...
          <p className="text-green-700 text-sm">No health alerts at this time. Your monorepo is running smoothly.</p>
        </div>
      </div>
    );
  }
