...
export default function ConfigInspectorHeader({ onRefresh, loading = false }: ConfigInspectorHeaderProps) {
  return (
    <div className="flex items-center justify-between">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Configuration Inspector</h1>
