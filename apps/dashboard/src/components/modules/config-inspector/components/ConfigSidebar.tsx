  ...
  return (
    <div className="bg-white rounded-lg shadow border h-full flex flex-col">
      ...
      <div className="p-4 border-b border-gray-200">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Configuration Files</h3>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                      <span className={`inline-flex px-2 py-0.5 text-xs font-semibold rounded-full ${getTypeColor(config.type)}`}>
                        {config.type}
                      </span>
