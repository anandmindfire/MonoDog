...
export default function ConfigPreview({ 
  ...
  const formattedContent = language === 'json' ? formatJson(displayContent) : displayContent;
  ...
  return (
    <div className="bg-white rounded-lg shadow border h-full flex flex-col">
      ...
      <div className="flex-1 overflow-auto">
        <pre className={`h-full p-4 text-sm font-mono bg-gray-50 overflow-auto ${getSyntaxHighlightClass(language)}`}>
