...
export default function PackageDetailTabs({ activeTab, onTabChange }: PackageDetailTabsProps) {
  const tabs = [
    { id: 'overview' as const, label: 'Overview', icon: CubeIcon },
    { id: 'dependencies' as const, label: 'Dependencies', icon: DocumentTextIcon },
