...
import { getStatusColor, getTypeColor, getPackageTypeIcon } from '../utils/dependency.utils';
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      <div className="p-6 border-b border-gray-200">
        <h3 className="text-lg font-medium text-gray-900">Package Dependencies</h3>
              ...
              >
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <div className="text-2xl mr-3">{getPackageTypeIcon(pkg.type)}</div>
                    <div>
                  ...
                  <div className="text-sm text-gray-900">
                    ...
                    {pkg.dependencies.length > 0 && (
                      <div className="text-xs text-gray-500 mt-1">
                        ...
                        {pkg.dependencies.length > 3 && ` +${pkg.dependencies.length - 3} more`}
                      </div>
                    )}
                  </div>
                </td>
                  ...
                  <div className="text-sm text-gray-900">
                    ...
                    {pkg.dependents.length > 0 && (
                      <div className="text-xs text-gray-500 mt-1">
                        ...
                        {pkg.dependents.length > 3 && ` +${pkg.dependents.length - 3} more`}
                      </div>
                    )}
                  </div>
                </td>
