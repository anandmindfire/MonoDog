  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow border">
      ...
      <div className="space-y-4">
        {/* Package Types */}
        <div>
          <h5 className="text-xs font-medium text-gray-700 mb-2">Package Types</h5>
        ...
        {/* Status Indicators */}
        <div>
          <h5 className="text-xs font-medium text-gray-700 mb-2">Health Status</h5>
          <div className="grid grid-cols-3 gap-2 text-xs">
            <div className="flex items-center space-x-2">
        ...
        {/* Visual Elements */}
        <div>
          <h5 className="text-xs font-medium text-gray-700 mb-2">Visual Elements</h5>
          <div className="space-y-1 text-xs">
            <div className="flex items-center space-x-2">
              <svg width="16" height="8">
                <line x1="0" y1="4" x2="16" y2="4" stroke="#6B7280" strokeWidth="2" markerEnd="url(#arrow)" />
                <defs>
        ...
        {/* Interaction Guide */}
        <div>
          <h5 className="text-xs font-medium text-gray-700 mb-2">Interactions</h5>
