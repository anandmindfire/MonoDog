...
export default function CircularDependencies({ cycles, packages, onPackageSelect }: CircularDependenciesProps) {
    ...
    return (
      <div className="bg-white p-6 rounded-lg shadow border">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900">Circular Dependencies</h3>
        ...
        <div className="text-center py-8">
          ...
          <h4 className="text-green-800 font-medium mb-1">No Circular Dependencies!</h4>
          ...
          >
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center space-x-2">
                <span className="text-lg">{getSeverityIcon(cycle.severity)}</span>
