      ...
      <div className="pl-64">
        ...
        <header className="bg-white shadow-soft border-b border-neutral-200 flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-6 ml-8">
              <div className="flex items-center gap-2 text-sm text-neutral-700">
                ...
                <span>CPU: <span className="font-medium">32%</span></span>
              </div>
              <div className="flex items-center gap-2 text-sm text-neutral-700">
                <ChartBarIcon className="h-5 w-5 text-primary-500" />
                <span>Memory: <span className="font-medium">2.1 GB / 8 GB</span></span>
              </div>
            </div>
          </div>
          {/* User info */}
          <div className="flex items-center gap-3">
            ...
            <img src="https://ui-avatars.com/api/?name=John+Doe&background=0D8ABC&color=fff" alt="User Avatar" className="h-8 w-8 rounded-full border border-neutral-200" />
          </div>
        </header>
