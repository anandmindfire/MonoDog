...
export default function BrandingSettings({ config, onConfigChange }: SettingsComponentProps) {
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">URL to your company logo</p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Primary Color
            ...
            <p className="text-xs text-gray-500 mt-1">Primary brand color for buttons and accents</p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Secondary Color
            ...
            <p className="text-xs text-gray-500 mt-1">Secondary color for hover states and highlights</p>
          </div>
        </div>
        ...
        <div className="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              <div 
                className="w-8 h-8 rounded-lg border border-gray-300"
                style={{ backgroundColor: config.branding?.secondaryColor || '#1E40AF' }}
              />
