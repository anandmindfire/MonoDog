...
import { ConfigurationProps, DashboardConfig, ConfigurationTab } from './types/config.types';
...
export default function Configuration({ isOpen, onClose, onSave, currentConfig }: ConfigurationProps) {
  const [config, setConfig] = useState<DashboardConfig>(mergeWithDefaults(currentConfig));
