...
export const getInitialSteps = (): SetupStep[] => [
  {
    ...
    description: 'Configure your monorepo directory structure and package manager',
    completed: false,
    required: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Connect with your CI/CD providers (GitHub Actions, GitLab CI, etc.)',
    completed: false,
    required: false,
  },
  {
...
// Calculate progress
export const calculateProgress = (steps: SetupStep[], currentStep: number): SetupProgress => {
  return {
    currentStep,
...
export const canProceedToNext = (steps: SetupStep[], currentStep: number): boolean => {
...
export const markStepAsComplete = (steps: SetupStep[], stepId: string): SetupStep[] => {
